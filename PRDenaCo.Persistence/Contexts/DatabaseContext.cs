...
using PRDenaCo.Domain.Entities.Users;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.Logging;
using static PRDenaCo.Common.Enums;


namespace PRDenaCo.Persistence.Contexts
{
    public class DatabaseContext : IDatabaseContext
    {
            ...
            try
            {
                ...
                if (dtCompany.Rows.Count > 0)
                    companyGetDto.RequestCompany = new RequestCompanyDto()
                    {
                        ...
                        Company_DateSeperator = Convertor.ToByte(dtCompany.Rows[0]["Company_DateSeperator"]),
                        ...
                        Company_TransactionType = Convertor.ToByte(dtCompany.Rows[0]["Company_TransactionType"]),
                        Company_WebAddress = dtCompany.Rows[0]["Company_WebAddress"].ToString(),
                        Country_Id = Convertor.ToByte(dtCompany.Rows[0]["Country_Id"]),

                        Currency_Name = dtCompany.Rows[0]["Currency_Name"].ToString(),
                       // Currency_Symbol = dtCompany.Rows[0]["Currency_Symbol"].ToString(),

                        DateFormats_Id = Convertor.ToByte(dtCompany.Rows[0]["DateFormats_Id"]),
        ...
        public ResultUserChangeDto Sp_CompanyUsers_Change(int CompanyUsers_Id)
        {
            ...
            try
            {
                ...
                if (ds.Tables[0].Rows.Count > 0)
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        resultUserChangeDto.Menus.Add(new MenuItemDto() { Id = Convertor.ToInt(dr["MenuOptions_Id"]), Title = dr["MenuOptions_Title"].ToString(), Url = dr["MenuOptions_Url"].ToString(), ParentId = Convertor.ToInt(dr["MenuOptions_ParentId"]) });
                    }

                if (ds.Tables[1].Rows.Count > 0)
                {
                    resultUserChangeDto.Company_TransactionType = Convertor.ToByte(ds.Tables[1].Rows[0]["Company_TransactionType"]);
                    resultUserChangeDto.DateFormats_Id = Convertor.ToByte(ds.Tables[1].Rows[0]["DateFormats_Id"]);
                    resultUserChangeDto.Company_DateSeperator = Convertor.ToByte(ds.Tables[1].Rows[0]["Company_DateSeperator"]);
                    resultUserChangeDto.Company_Id = Convertor.ToInt(ds.Tables[1].Rows[0]["Company_Id"]);
                }
                else
                {
        ...
        public ResultUserloginDto Sp_Users_Login(string userName, string password, out byte errorType)
        {
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0)
                    errorType = Convertor.ToByte(ds.Tables[0].Rows[0][errorType]);
                if (errorType != 0)
                ...
                else
                {
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                        resultUserloginDto.Accounts_Id = Convertor.ToInt(ds.Tables[1].Rows[0]["Accounts_Id"]);
                    ...
                    if (ds.Tables[2].Rows.Count > 0)
                        ...
                        {
                            resultUserloginDto.UserInBusiness.Add(new UserBusinessDto() { CompanyUsers_Id = Convertor.ToInt(dr["CompanyUsers_Id"]), Company_BusinessName = dr["Company_BusinessName"].ToString() });
                        }

                    if (ds.Tables[3].Rows.Count > 0)
                        foreach (DataRow dr in ds.Tables[3].Rows)
                        {
                            resultUserloginDto.Menus.Add(new MenuItemDto() { Id = Convertor.ToInt(dr["MenuOptions_Id"]), Title = dr["MenuOptions_Title"].ToString(), Url = dr["MenuOptions_Url"].ToString(), ParentId = Convertor.ToInt(dr["MenuOptions_ParentId"]) });
                        }

                    if (ds.Tables[4].Rows.Count > 0)
                    {
                        resultUserloginDto.Company_TransactionType = Convertor.ToByte(ds.Tables[4].Rows[0]["Company_TransactionType"]);
                        resultUserloginDto.DateFormats_Id = Convertor.ToByte(ds.Tables[4].Rows[0]["DateFormats_Id"]);
                        resultUserloginDto.Company_DateSeperator = Convertor.ToByte(ds.Tables[4].Rows[0]["Company_DateSeperator"]);
                        resultUserloginDto.Company_Id = Convertor.ToInt(ds.Tables[4].Rows[0]["Company_Id"]);
                        resultUserloginDto.Users_Id = Convertor.ToInt(ds.Tables[4].Rows[0]["Users_Id"]);
        ...
        public ResultUserForgotDto Sp_Users_Forget(string userName, out byte errorType)
        {
            ...
            try
            {
                ...
                else
                {
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                        resultUserForgotDto.Accounts_Id = Convertor.ToInt(ds.Tables[1].Rows[0]["Accounts_Id"]);
                        resultUserForgotDto.Users_Id = Convertor.ToInt(ds.Tables[1].Rows[0]["Users_Id"]); ;
                    }
                    else
                    {
        ...
        public List<ResultMenuDto> Sp_CompanyUsers_PolicyGet(int companyUsers_Id)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        MenuOptions_Id = Convertor.ToInt(dr["MenuOptions_Id"]),
                        MenuOptions_Title = dr["MenuOptions_Title"].ToString(),
                        MenuOptions_ParentId = Convertor.ToInt(dr["MenuOptions_ParentId"]),
                        CompanyUsers_MenuId = Convertor.ToInt(dr["CompanyUsers_MenuId"]),
                        // MenuOptions_Icon = dr["MenuOptions_Icon"].ToString(),
                        // MenuOptions_Order = Convertor.ToInt(dr["MenuOptions_Order"]),
                        MenuOptions_IsMenu = Convertor.ToBool(dr["MenuOptions_IsMenu"])
                    }); ;
                }
        ...
        public List<ResultUserBranchDto> sp_UsersAccess_Get(int Id, int Company_Id, byte kind)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        Id = Convertor.ToInt(dr["Id"]),
                        Users_Description = dr["Users_Description"].ToString(),
                        CompanyUsers_Id = Convertor.ToInt(dr["CompanyUsers_Id"]),
        ...
        public List<CompanyBranch_Dto> sp_CompanyBranch_List(int Company_Id)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    companyBrancheLst.Add(new CompanyBranch_Dto() { Company_Id = Company_Id, CompanyBranch_Id = Convertor.ToInt(dr["CompanyBranch_Id"]), CompanyBranch_Title = dr["CompanyBranch_Title"].ToString() });
                }
        ...
        public List<CompaniesList_Dto> Sp_Company_List(int Accounts_Id)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    companyLst.Add(new CompaniesList_Dto() { Company_Id = Convertor.ToInt(dr["Company_Id"]), Company_BusinessName = dr["Company_BusinessName"].ToString(), Company_AliasName = dr["Company_AliasName"].ToString(), Company_TransactionType = Convertor.ToByte(dr["Company_TransactionType"]) });
                }
                return companyLst;
            }
            catch (Exception ex)
        ...
        public InsertAccountDto Sp_Account_Insert(string email, string title, string password)
        {
            ...
            try
            {
                ...
                return new InsertAccountDto() { Accounts_Id = Convertor.ToInt(dt.Rows[0]["AccountId"]), Users_Id = Convertor.ToInt(dt.Rows[0]["UserId"]), Error = Convertor.ToByte(dt.Rows[0]["Error"]) };
            }
            catch (Exception ex)
            {
                _logger.LogError(LogEvent.DbErrorOccurred, ex.Message);
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            AccountGroup_Id = Convertor.ToInt(dr["AccountGroup_Id"]),
                            AccountGroup_Name = dr["AccountGroup_Name"].ToString(),
                            AccountGroup_Parent = Convertor.ToInt(dr["AccountGroup_Parent"]),
                            Company_Id = Convertor.ToInt(dr["Company_Id"])
                        }); ;
                    }
            ...
            try
            {
                ...
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        {
                            Account_Node_Id = Convertor.ToInt(dr["Node_Id"]),
                            Account_Node_Name = dr["Node_Name"].ToString(),
                            Account_AccountGroup_Parent = Convertor.ToInt(dr["AccountGroup_Parent"]),
                            Account_Is_Group = Convertor.ToInt(dr["IsGroup"])
                        });
                    }
                }
                if (ds.Tables.Count > 1 && ds.Tables[1].Rows.Count > 0)
            ...
            try
            {
                ...
                if (ds.Tables.Count > 3 && ds.Tables[3].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[3].Rows)
                    {
                        ...
                        {
                            Currency_Id = Convertor.ToInt(dr["Currency_Id"]),
                            Currency_Name = dr["Currency_Name"].ToString(),
                            Rate = Convertor.ToFloat(dr["Rate"])
                        });
                    }
                }
                if (ds.Tables.Count > 4 && ds.Tables[4].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[4].Rows)
                    {
                        ...
                        {
                            CompanyBranch_Id = Convertor.ToInt(dr["CompanyBranch_Id"]),
                ...
                if (ds.Tables.Count > 5 && ds.Tables[5].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[5].Rows)
                    {
                        ...
                        {
                            Projects_Id = Convertor.ToInt(dr["Projects_Id"]),
                ...
                if (ds.Tables.Count > 6 && ds.Tables[6].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[6].Rows)
                    {
                        ...
                        {
                            Ledger_Id = Convertor.ToInt(dr["Ledger_Id"]),
                ...
                if (ds.Tables.Count > 8 && ds.Tables[8].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[8].Rows)
                    {
                        ...
                        {
                            CostCenter_Id = Convertor.ToInt(dr["CostCenter_Id"]),
                ...
                if (ds.Tables.Count > 9 && ds.Tables[9].Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Tables[9].Rows)
                    {
                        ...
                        {
                            VoucherLabel_Id = Convertor.ToInt(dr["VoucherLabel_Id"]),
        ...
        public List<VoucherTypeDto> sp_SuffixPrefix_Load()
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    voucherTypeLst.Add(new VoucherTypeDto() { voucherType_Id = Convertor.ToInt(dr["voucherType_Id"]), voucherType_Name = dr["voucherType_Name"].ToString() });
                }
        ...
        public ExchangeRate_Dto sp_ExchangeRate_GetList(int Company_Id, DateTime? dateTime)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        Currency_Id = Convertor.ToLong(dr["Currency_Id"]),
                        Currency_Name = dr["Currency_Name"].ToString(),
                        ExchangeRate_Id = Convertor.ToLong(dr["ExchangeRate_Id"]),
                        ExchangeRate_Narration = "",
                        No = counter++,
                        Rate = Convertor.ToDecimal(dr["Rate"]),
        ...
        public List<BenefeciaryList_Dto> sp_Beneficiary_List(int Company_Id)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    {
                        Beneficiary_Id = Convertor.ToInt(dr["Beneficiary_Id"]),
