...
namespace PRDenaCo.Application.Services.Account.Commands.AddNewAccountLedger
{
    ...
    public class AddNewAccountLedgerService: IAddNewAccountLedgerService
    {
        ...
        public ResultDto Execute(AccountLedgerDto accountLedgerDto)
        {
            try
            {
                if (this._context.sp_AccountLegder_Insert(accountLedgerDto) == 2)
                {
    ...
    public class AccountLedgerDto
    {
        ...
        {
            this.AcountGroupList = new List<AccountGroup>();
            this.TermsAndConditionList = new List<TermsAndCondition>();
