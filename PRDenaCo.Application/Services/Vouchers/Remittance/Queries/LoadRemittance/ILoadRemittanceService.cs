...
namespace PRDenaCo.Application.Services.Vouchers.Remittance.Queries.LoadRemittance
{
    ...
    public class LoadRemittanceService : ILoadRemittanceService
    {
        ...
        {
            var data = this._context.sp_Remittance_LoadPage(Company_Id, VoucherTypeId, CurrentDate, VoucherDate);
