...
namespace PRDenaCo.Web.Utilities
{
    public static class ModelsToDtos
    {
        public static RequestCompanyDto CompanyToDto(CompanyModel model, string customFormat)
        {
            ...
            dto.Accounts_Id = model.Accounts_Id;
            dto.Company_Address = model.Address;
            dto.Company_AliasName = model.AliasName;
            dto.Company_BusinessName = model.BussinessName;
            dto.Company_DateSeperator = model.DateSeperator;
            dto.Company_Email = model.Email;
            dto.Company_Fax = model.Fax;
            dto.Company_Id = model.CompanyId;
